                      ...
                      child: ListView(
                        children: [
                          Padding(
                            ...
                            child: statusBatch == 'Take Medicine on Hospital'
                                ? ListView(
                                    shrinkWrap: true,
                                                                ...
                                                                child:
                                                                  ...
                                                                  borderRadius:
                                                                      BorderRadius
                                                                          .circular(
                                                                              50),
                                                                  child: tobeProvider.getTobe?.profil != null
                                                                      ? Image.network(
                                                                    "${ApiConfig.urlFoto}${tobeProvider.getTobe?.profil}",
                                                                    fit: BoxFit
                                                                        .cover,
                                                                    errorBuilder:
                                                                        (context,
                                                              ...
                                                              Row(
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                      width: 90,
                                                                      child: Text(
                                                                          "${tobeProvider.getTobe?.jam} - Harus ambil Medicine",
                                                                          style:
