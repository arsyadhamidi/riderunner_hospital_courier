              ...
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: dikirimProvider.listDikirm?.length ?? 0,
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              width: 100,
                                              child: Text("${dikirimProvider.listDikirm?[index].name}",
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                SizedBox(width: 10),
                                                Text("${dikirimProvider.listDikirm?[index].tanggal}",
                                                    style: TextStyle(
                                                        fontWeight: FontWeight.w700,
                                                        fontSize: 13)),
                                              ],
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Container(
                                                    width: 90,
                                                    child: Text("${dikirimProvider.listDikirm?[index].jam} - Harus ambil Medicine",
                                                        style: TextStyle(
                                                            fontSize: 13))),
                                              ],
                                            ),
