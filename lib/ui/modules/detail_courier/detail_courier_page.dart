...
class _DetailCourierPageState extends State<DetailCourierPage> {
  ...
  Widget build(BuildContext context) {
          ...
          builder: (context, detailProvider, child) {
            return Scaffold(
                ...
                body: RefreshIndicator(
                  onRefresh: () => detailProvider.refreshCourier(widget.data?.id),
                  child: Container(
                                    ...
                                    children: [
                                      Text("Shipping Costs",
                                          style: TextStyle(
                                              ...
                                              fontSize: 18)),
                                      SizedBox(height: 7),
                                      Text("RM${widget.shipping.toStringAsFixed(2)}",
                                          style: TextStyle(color: Colors.grey)),
                                    ],
                                  ),
                                ],
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            CrossAxisAlignment.start,
                                            children: [
                                              Text("${widget.data?.hospital?.rumahSakit}",
                                                  style: TextStyle(
                                                      fontWeight:
                                                      FontWeight.bold)),
                                              SizedBox(height: 3),
                ...
                bottomNavigationBar: Padding(
                  ...
                  child: detailProvider.isButtonClicked
                      ? MaterialButton(
                    onPressed: () {
                      setState(() {
                        detailProvider.saveButtonStatus(false);
                        detailProvider.isButtonClicked = false;
                      });
                    },
                              ...
                              children: [
                                ...
                                MaterialButton(
                                  onPressed: () {
                                    ...
                                    setState(() {
                                      detailProvider.isButtonClicked = true;
                                    });
                                    Navigator.pop(context);
                                  },
                                  elevation: 3,
    ...
    if(widget.data?.statusBatch == 'Take Medicine on Hospital'){
      return ChangeNotifierProvider(
        create: (context) => DetailCourierProvider(widget.data?.id),
        child: Consumer<DetailCourierProvider>(
          builder: (context, detailProvider, child) {
                  ...
                  child: Row(
                    ...
                    children: [
                      MaterialButton(
                        ...
                        child: Row(
                          children: [
                            Text("Status Update", style: TextStyle(color: Colors.white)),
                            SizedBox(width: 5),
                      ...
                      MaterialButton(
                        ...
                        child: Row(
                          children: [
                            Text("Tracking Lane", style: TextStyle(color: Colors.white)),
                            SizedBox(width: 5),
                            Icon(Icons.arrow_circle_right_rounded, color: Colors.white, size: 16)
                          ],
                        ),
                      ),
                    ],
